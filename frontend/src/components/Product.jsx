    ...
    <Link to={`product/${_id}`}>
      <article className='text-center transition-all duration-300 cursor-pointer ease group hover:shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px] hover:bg-white'>
        ...
        <div className='px-4 pb-4 pt-2'>
          ...
          <h3 className='text-lg font-normal leading-none'>{name}</h3>
          <p className='mt-1 font-semibold text-lg'>₹{price}</p>
          ...
          <div className='flex justify-center items-center gap-1 mt-1'>
            ...
            <button className='px-5 py-1.5 uppercase bg-[#eee] text-sm text-black font-medium transition-colors duration-300 ease group-hover:bg-black group-hover:text-white'>Add to cart</button>
