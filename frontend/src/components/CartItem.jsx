...
function CartItem({ product, image, name, quantity, price, stock, readonly = false }) {
  ...
  return (
    <tr className="max-sm:block">
      ...
      <td className="px-2 max-sm:block sm:py-3">
        {formatPrice(price)}
      </td>
      {
        !readonly ? (
          ...
          <td className="p-2 max-sm:block sm:py-3">{quantity}</td>
        )
      }
      <td className="px-2 max-sm:block sm:py-3">
